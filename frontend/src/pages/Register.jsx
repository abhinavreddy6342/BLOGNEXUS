...
function Register() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      console.error("BLOGNEXUS registration error:", requestError);
      ...
      if (typeof detail === "string") {
        ...
        setError(
          detail[0]?.msg || "Registration failed. Please check your details.",
        );
      } else {
        setError(
  ...
  return (
    <div className="relative min-h-screen overflow-hidden pt-28">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute left-[6%] top-[20%] h-72 w-72 rounded-full bg-cyan-400/[0.045] blur-3xl" />
        <div className="absolute right-[7%] top-[25%] h-80 w-80 rounded-full bg-cyan-300/[0.035] blur-3xl" />
        <div className="absolute bottom-[4%] left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-sky-400/[0.025] blur-3xl" />
      </div>

      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-7rem)] w-[92%] max-w-7xl items-center justify-center pb-20">
        <div className="grid w-full max-w-5xl overflow-hidden rounded-3xl border border-white/10 bg-white/[0.02] shadow-[0_0_80px_rgba(34,211,238,0.035)] backdrop-blur-xl lg:grid-cols-[1.1fr_0.9fr]">
          {/* Register panel */}
          <motion.div
          ...
          >
            ...
            <div className="mt-3">
              ...
              <p className="mt-4 max-w-md text-sm leading-7 text-white/35">
                Create your BLOGNEXUS identity and start sharing ideas with
                the community.
              </p>
            </div>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {passwordRequirements.map((requirement) => (
                    <span
                      ...
                      className={`inline-flex items-center gap-1.5 rounded-lg border px-2 py-1 font-mono text-[8px] tracking-[0.1em] transition-all duration-[180ms] ${
                        requirement.valid
                          ? "border-cyan-400/20 bg-cyan-400/[0.05] text-cyan-300/70"
                          : "border-white/10 bg-white/[0.015] text-white/20"
                      }`}
                    >
                      <Check
                        size={10}
          ...
          <motion.div
            ...
            className="hidden border-l border-white/10 bg-cyan-400/[0.015] p-10 lg:flex lg:flex-col lg:justify-between lg:p-12"
          >
            <div>
              <div className="font-mono text-[9px] uppercase tracking-[0.2em] text-cyan-300/55">
                BLOGNEXUS // COMMUNITY
              ...
              <h2 className="mt-8 font-audiowide text-3xl leading-tight text-white">
                BUILD.
                <br />
                SHARE.
                <br />
              ...
              <p className="mt-6 text-sm leading-7 text-white/30">
                Your account gives you access to the complete BLOGNEXUS
                experience.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {[
                ["01", "PUBLISH", "Turn your ideas into stories."],
                ["02", "DISCOVER", "Find perspectives from others."],
                ["03", "ENGAGE", "Like, comment, and bookmark."],
                ["04", "GROW", "Build your identity and audience."],
